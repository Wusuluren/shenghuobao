...
class CsvConverter {
  ...
  CsvConverter.Excel(
      {this.fieldDelimiter: ',', this.quoteSymbol: '"', this.lineDelimiter}) {
  ...
  String compose(List<List<String>> data) {
    var encoder =
        new _Composer(this.fieldDelimiter, this.quoteSymbol, lineDelimiter);
...
class _InQuotedFieldState extends _State {
  ...
  _State onEoF() => throw new ArgumentError(
      "Unexpected end of file: quoted record is uncompleted");
